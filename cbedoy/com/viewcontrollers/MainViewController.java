...
import com.sprites.objets.Mario;
 ...
 *
 */
public class MainViewController extends StageViewController {
	...
	public MainViewController(boolean applet) {
		super(CANVAS);
		setFPS(80);
		setSize(960, 640);
		...
		// imagen a el objeto StageViewController (superclase).
	...
	public synchronized void updateStage() {
		...
		if (!gameOver && Coin.N_COINS == Coin.COINS_CATCHED) {
			gameOver();
			final StageViewController s = this;
	...
	public static void main(String[] args) {
		MainViewController p = new MainViewController();
