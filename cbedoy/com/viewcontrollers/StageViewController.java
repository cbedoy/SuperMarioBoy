...
// StageViewController.java --------------------------------------------------------

package com.viewcontrollers;


import com.loaders.ImagesLoader;
import com.loaders.SoundsLoader;
import com.utils.ImagesEffects;
...
/**
 * StageViewController which can be used for any game.
 *
 * @author WilyWill
 */
public abstract class StageViewController implements Runnable,
	...
	// MODES of the StageViewController
	...
	//  end of MODES of the StageViewController
	...
	/**
	 * An empty StageViewController was created. To start the game must to
	 * call <code>startGame()</code>.
	 *
	 * @param mode Surface over that the game will show.
	 *
	 */
	public StageViewController(int mode) {
		...
		switchMode(mode);
	}  // end of StageViewController() constructor
	...
	public void switchMode(int mode) {
		...
		switch(mode) {
			...
			default: throw new IllegalArgumentException(
						"The mode of the StageViewController is invalid.");
		}
	...
	public void run() {
		...
		while(running) {
			...
			// LOOP game
			updateStage(); // Update game stageViewController
			updateScreen(); // Render stageViewController in a buffer
...
}  // end of Class StageViewController


//  end of StageViewController.java -----------------------------------------------
